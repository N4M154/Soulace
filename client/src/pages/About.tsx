...
const AboutPage = () => {
  ...
  const developers: Developer[] = [
    ...
    },
    {
      ...
      role: "Backend Developer",
      description:
        "Namisa is a jack of all trades. She focuses on the backend more.",
    },
    {
      name: "Md H R Alif",
      role: "Backend Developer",
  ...
  const features: Feature[] = [
    ...
    {
      title: "Blogs/Articles",
      description: "Access mental health content for learning and support.",
    },
    {
      title: "Mood-Based Playlists",
      description: "Listen to playlists tailored to your emotional state.",
    },
    {
      title: "Progress Tracker",
      description: "Stay motivated with personalized progress tracking.",
  ...
  return (
    <div className="flex dark:bg-[#2c2c2c]">
      <SideButtons />
      <div
        id="main-content"
        className="transition-all duration-300"
      ...
      >
        ...
        <div className="min-h-screen bg-white dark:bg-[#2c2c2c]">
          {/* Hero Section */}
          <div className="relative overflow-hidden bg-gradient-to-r from-teal-600 dark:from-teal-950 to-white dark:to-teal-700 text-white py-16 px-8 rounded-2xl shadow-lg dark:shadow-black mx-4 mt-6 mb-6">
            <div className="relative z-10">
              ...
              <p className="text-xl text-teal-50 max-w-2xl">
                A platform dedicated to promoting mental well-being through
          ...
          <div className="container mx-auto py-12 px-8 bg-white dark:bg-[#2c2c2c] bg-opacity-95 rounded-lg ">
            {/* Developers Information */}
            <section className="mb-16">
              <h2 className="text-4xl font-extrabold text-teal-700 dark:text-teal-500 mb-8 text-center">
                Meet Our Team
              </h2>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
                {developers.map((developer, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-br from-teal-50 dark:from-black dark:to-teal-800 to-white p-6 rounded-lg shadow-lg dark:shadow-black hover:shadow-xl dark:hover:shadow-xl dark:hover:shadow-black transition-all"
                  >
                    <h3 className="text-xl font-semibold text-teal-700 dark:text-teal-400 mb-2">
                      {developer.name}
                    </h3>
                    <p className="text-sm font-medium dark:font-normal text-teal-600 dark:text-teal-100 mb-4">
                      {developer.role}
                    </p>
            ...
            <section className="mb-16">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-center max-w-4xl mx-auto">
                Mental health is essential for overall well-being, yet it's
                often stigmatized. Our mission is to create a comprehensive
                platform that empowers individuals to track their emotional
                health, access tools for mental well-being, and find the support
                they need to thrive.
              </p>
            </section>
            ...
            <section className="mb-16">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-center max-w-4xl mx-auto mb-8">
                In the Bangladeshi context, we address the unique challenges of
                limited mental health awareness and access to resources. By
                offering culturally tailored content and tools, we bridge the
                gap in support systems.
              </p>
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-center max-w-4xl mx-auto">
                Globally, we stand out by integrating advanced sentiment
                analysis, community-driven support, and personalized progress
                tracking to provide a holistic mental health solution.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 list-none text-center">
                {features.map((feature, index) => (
                  <li
                    key={index}
                    className="bg-white dark:bg-teal-950 rounded-lg shadow-lg dark:shadow-black p-6 hover:shadow-xl transition-all"
                  >
                    <h3 className="text-xl font-semibold dark:font-normal text-teal-600 dark:text-teal-400 mb-2">
                      {feature.title}
                    </h3>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">
                      {feature.description}
