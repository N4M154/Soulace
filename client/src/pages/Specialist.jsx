  ...
  return (
    <div>
      ...
      <div className="min-h-screen bg-white flex flex-col items-center p-6">
        ...
        {/* Display Results */}
        {result !== null && !error && (
          <div className="mt-8 bg-teal-100 border border-teal-200 text-teal-800 px-4 py-3 rounded relative w-full max-w-2xl">
            {result > 0.5 ? (
              <div>
                <strong className="font-bold">Assessment Result:</strong>
                <p className="mt-2">
                  Based on your inputs, there's a {(result * 100).toFixed(2)}%
                  chance you might benefit from talking to a professional.
                </p>
              </div>
            ) : (
              <div>
                ...
                <p className="mt-2">
                  Based on your inputs, there's a {(result * 100).toFixed(2)}%
                  likelihood that professional help may not be necessary right
                  now.
                </p>
              </div>
            )}
