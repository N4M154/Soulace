  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        ...
        {/* Hero Section */}
        <div className="bg-gradient-to-b from-teal-900 to-teal-200 rounded-2xl text-white py-4 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-5xl font-bold mb-6">Your Mental Health Matters</h1>
                <p className="text-xl mb-8 text-teal-100">
                  Take our comprehensive assessment to understand your mental well-being better. 
        ...
        <div className="min-h-screen bg-gradient-to-b from-white to-teal-50 flex flex-col items-center p-6">
          <div className="text-center mb-12 mt-8">
            <h2 className="text-4xl font-bold text-teal-800 mb-4">Mental Health Assessment</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Complete this comprehensive assessment to receive personalized insights about your mental well-being. 
              Your honest responses will help us provide the most accurate recommendations.
            </p>
          </div>

          <form
            onSubmit={handleSubmit}
            className="bg-white shadow-xl rounded-2xl p-8 max-w-2xl w-full mb-12"
          >
            <div className="bg-teal-50 -mx-8 -mt-8 mb-8 p-6 rounded-t-2xl border-b border-teal-100">
              <h3 className="text-2xl font-semibold text-teal-800">Personal Information</h3>
              <p className="text-teal-600 mt-2">All information provided is kept strictly confidential</p>
            </div>
          ...
          {result !== null && !error && (
            <div className="mt-8 bg-teal-50 border-l-4 border-teal-500 text-teal-800 p-6 rounded-r w-full max-w-2xl">
              ...
              {result > 0.5 ? (
                <p className="text-lg">
                  Based on your responses, there's a {(result * 100).toFixed(2)}% indication that professional support could be beneficial for your mental well-being.
                </p>
              ) : (
                <p className="text-lg">
                  Based on your responses, there's a {(result * 100).toFixed(2)}% indication that you're managing well at this time.
                </p>
              )}
            </div>
          )}
