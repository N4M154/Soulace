...
const MentalHealthContent = () => {
  ...
  <p style={{ textAlign: "center", color: "gray", margin: "5px 0 0" }}>
    Videos can provide inspiration, practical tips, and insights to boost your mental well-being.
        ...
        <div style={{ maxWidth: "1200px", margin: "40px auto", padding: "20px" }}>
          <h2 style={{ textAlign: "center", color: "#333", fontSize: "24px" }}>How These Contents Help You</h2>
          <p style={{ textAlign: "center", fontSize: "16px", color: "#555" }}>
            By exploring these articles and videos, you can gain valuable insights into improving mental well-being, reducing stress, and adopting healthier habits. The curated content serves as a source of inspiration and education, helping you to build resilience and find practical solutions for managing mental health challenges in everyday life.
          </p>
        </div>
      </div>
    </div>
