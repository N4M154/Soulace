...
const services = [
  {
    ...
    description: "Feeling down? Let's lift your spirits with personalized music recommendations.",
  ...
  {
    name: "Mood Booster",
    description: "Looking for a smile? Discover uplifting content and activities.",
    image: "https://images.unsplash.com/photo-1533227268428-f9ed0900fb3b?auto=format&fit=crop&w=800",
    route: "/jokeoftheday"
  },
  {
    name: "Community Portal",
  ...
  {
    name: "Daily Contents",
    description: "Drift into serenity with our calming stories and tranquil visuals, crafted to guide you into peaceful rest.",
...
const mockUserData = {
  ...
  journalEntries: [
    ...
    },
    {
      ...
      time: "9:45 PM",
      mood: "Neutral",
      content: "Had a mixed day. Started with some challenges but managed to practice my breathing exercises..."
    }
  ],
  todoList: [
  ...
  achievements: [
    { title: "Early Bird", description: "Complete morning meditation 5 days in a row", progress: 80 },
    { title: "Mindfulness Master", description: "Achieve 30 days meditation streak", progress: 60 },
    { title: "Sleep Champion", description: "Maintain good sleep schedule for a week", progress: 90 }
  ]
};
        ...
        <div className="relative h-full flex items-center px-8 md:px-16 max-w-7xl mx-auto">
          <div className="text-white max-w-2xl">
            ...
            <p className="text-xl opacity-90 mb-8">
              Hope you are doing well.Let's continue your journey to mental wellness and inner peace
            </p>
            <button
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          <div className="bg-white p-6 rounded-xl shadow-sm border border-teal-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-2xl font-bold text-gray-800">{mockUserData.sleepHours}h</p>
            <p className="text-sm text-gray-500">Quality: {mockUserData.averageSleepQuality}</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-teal-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-2xl font-bold text-gray-800">{mockUserData.currentMood}</p>
            <p className="text-sm text-gray-500">Avg: {mockUserData.averageMood}</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-teal-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-2xl font-bold text-gray-800">{mockUserData.meditationMinutes}min</p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-teal-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-2xl font-bold text-gray-800">{mockUserData.streakDays} days</p>
            <p className="text-sm text-gray-500">{mockUserData.totalSessions} total sessions</p>
          </div>
        </motion.div>
                ...
                {getVisibleServices().map((service, idx) => (
                  ...
                  >
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                      ...
                      <div className="p-6">
                        <h3 className="text-xl font-bold text-teal-800 mb-2">{service.name}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          >
            <h2 className="text-xl font-bold text-teal-800 mb-4">Today's Focus</h2>
          ...
          <motion.div
            ...
            className="bg-white p-6 rounded-xl shadow-sm border border-teal-100"
          >
            <h2 className="text-xl font-bold text-teal-800 mb-4">Daily Inspiration</h2>
        ...
        <motion.section
          ...
          className="mb-12"
        >
          <h2 className="text-2xl font-bold text-teal-800 mb-6">Your Achievements</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {mockUserData.achievements.map((achievement, index) => (
              <div key={index} className="bg-white p-6 rounded-xl shadow-sm border border-teal-100">
                <div className="flex items-center gap-3 mb-4">
                  <Star className="text-teal-500" />
                  <h3 className="font-semibold text-teal-800">{achievement.title}</h3>
                </div>
                ...
                <p className="text-sm text-gray-500 mt-2">{achievement.progress}% completed</p>
              </div>
            ))}
          </div>
        </motion.section>
        ...
        >
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-teal-800">Recent Journal Entries</h2>
            <button
              onClick={() => navigate("/journal")}
            ...
            {mockUserData.journalEntries.map((entry, index) => (
              <div key={index} className="border-b border-gray-100 pb-4 last:border-0">
                <div className="flex justify-between items-center mb-2">
                  <h3 className="font-medium text-gray-800">{entry.date} • {entry.time}</h3>
                  <span className={`px-3 py-1 rounded-full text-sm ${
                    entry.mood === "Positive" ? "bg-teal-100 text-teal-700" :
                    entry.mood === "Neutral" ? "bg-yellow-100 text-yellow-700" :
          ...
          >
            ...
            <p className="text-sm opacity-90">To log daily mood and get personalized suggestion</p>
          ...
          >
            ...
            <p className="text-sm opacity-90">Need specialist? Take a test, test using ML</p>
            <ArrowRight className="mt-4" />
          </motion.button>
        </div>
